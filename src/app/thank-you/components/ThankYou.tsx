...
import PhonePreview from '@/app/thank-you/components/PhonePreview';
import { formatPrice } from '@/lib/utils';
import { useQuery } from '@tanstack/react-query';
import { Loader2 } from 'lucide-react';
import { useSearchParams } from 'next/navigation';

// Thankyou page will have three states:
// 1. loading
// 2. Not yet paid
// 3. Paid
...
const ThankYou = () => {
  ...
  // This is for the state 1: Just a loading state
  if (data === undefined) {
    return (
  ...
  // From the server side function if we get false: that means the payment is still not paid(webhook has not been executed yet)
  // This is for the state 2: In short, we are waiting for the webhook to update the database
  if (data === false) {
    return (
      <div className="mt-24 flex w-full justify-center">
        <div className="flex flex-col items-center gap-2">
        ...
        <div className="mt-10 border-t border-zinc-200">
          <div className="mt-10 flex flex-auto flex-col">
            ...
            <p className="mt-2 text-sm text-zinc-600">
              We at CaseCanvas believe that a phone case doesn't only need to
